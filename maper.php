...
echo $lat; echo'_'; echo $lng; echo'_'; echo $zoom; echo'</td></tr></table>';?><br><br> 
<a href="https://maps.googleapis.com/maps/api/geocode/json?address=<?php echo $lat;?>+<?php echo $lng;?>+<?php echo $zoom;?>&key=AIzaSyAENKGpbOI9KaivcTR-MSobwnq9Fh83VDc">Ссылка будет открыта в новом окне</a> 
